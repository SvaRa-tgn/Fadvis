...
<div class="user-data-profile js-box-close hide" data-side="right">
    <div class="wrap-item-select js-order-value-box">
        ...
        : (
            ($patient->right_level === \App\Enum\ProthesisLevel::WRIST_KNOT)
                ? 'wrist-box'
                : ''
          )
                }}">
            ...
            @if(($patient->right_level  === \App\Enum\ProthesisLevel::SHOULDER_KNOT)
                ...
                {{($patient->right_level === \App\Enum\ProthesisLevel::ELBOW_KNOT) ? 'item-select-active' : ''}}">
                    Локтевой узел
                </li>
            @endif
            <li class="item-select-header-item js-wrist_knot
            {{($patient->right_level === \App\Enum\ProthesisLevel::WRIST_KNOT) ? 'item-select-active' : ''}}">
                Запястный узел
            </li>
        ...
        @if($patient->right_level  === \App\Enum\ProthesisLevel::SHOULDER_KNOT)
            <div class="wrap-knot-box js-shoulder_knot js-right" data-knot="shoulder_knot">
        ...
        @if(($patient->right_level  === \App\Enum\ProthesisLevel::SHOULDER_KNOT)
                || ($patient->right_level  === \App\Enum\ProthesisLevel::ELBOW_KNOT))
            <div class="wrap-knot-box js-elbow_knot js-right
            {{($patient->right_level !== \App\Enum\ProthesisLevel::ELBOW_KNOT) ? 'hide' : ''}}" data-knot="elbow_knot">
                <ul class="item-select-list">
                    <li class="item-select-item ">
                        <div class="data-item">
                ...
                <div class="order-bottom">
                    @if($patient->right_level === \App\Enum\ProthesisLevel::ELBOW_KNOT)
        ...
        <div class="wrap-knot-box js-wrist_knot js-right
        {{($patient->right_level !== \App\Enum\ProthesisLevel::WRIST_KNOT) ? 'hide' : ''}}" data-knot="wrist_knot">
            <ul class="item-select-list">
                <li class="item-select-item ">
                    <div class="data-item">
            ...
            <div class="order-bottom">
                @if($patient->right_level === \App\Enum\ProthesisLevel::WRIST_KNOT)
        ...
        <div class="wrap-knot-box js-nozzle js-right hide" data-knot="nozzle">
            <ul class="item-select-list">
                <li class="item-select-item ">
                    <div class="data-item">
