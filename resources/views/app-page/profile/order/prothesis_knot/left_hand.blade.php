    ...
    <li class="order-block-item js-block-item-products">
        ...
        <div class="user-data-profile js-box-close hide">
            @if($patient->left_level === \App\Enum\ProthesisLevel::SHOULDER_KNOT)
                <div class="order-body fieldset" data-level="shoulder_knot" data-side="left" data-server="left_hand">
                    <fieldset class="item-box">
                        ...
                        <div class="order-bottom">
                            <article class="order-bottom-link js-open-select green-color"
                                     data-knot="left-hand-shoulder-knot">Выбрать комплектующие
                            </article>
                        </div>
                    </fieldset>
                </div>
            ...
            @if($patient->left_level === \App\Enum\ProthesisLevel::SHOULDER_KNOT || $patient->left_level === \App\Enum\ProthesisLevel::ELBOW_KNOT)
                <div class="order-body fieldset" data-level="elbow_knot" data-side="left" data-server="left_hand">
                    <fieldset class="item-box">
                        ...
                        <div class="order-bottom">
                            <article class="order-bottom-link js-open-select green-color "
                                     data-knot="left-hand-elbow-knot">Выбрать комплектующие
                            </article>
                        </div>
                    </fieldset>
                </div>
            @endif
            @if($patient->left_level === \App\Enum\ProthesisLevel::SHOULDER_KNOT || $patient->left_level === \App\Enum\ProthesisLevel::ELBOW_KNOT || $patient->left_level === \App\Enum\ProthesisLevel::WRIST_KNOT)
                <div class="order-body fieldset" data-level="wrist_knot" data-side="left" data-server="left_hand">
                    <fieldset class="item-box">
                        ...
                        <div class="order-bottom">
                            <article class="order-bottom-link js-open-select green-color "
                                     data-knot="left-hand-wrist-knot">Выбрать комплектующие
                            </article>
                        </div>
                    </fieldset>
                </div>
            @endif
            <div class="order-body fieldset" data-level="nozzle" data-side="left" data-server="left_hand">
                <fieldset class="item-box">
                    ...
                    <div class="order-bottom">
                        <article class="order-bottom-link js-open-select green-color js-open-select"
                                 data-knot="left-hand-nozzle">Выбрать комплектующие
                        </article>
                    </div>
                </fieldset>
            </div>
