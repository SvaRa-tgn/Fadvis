@if($patient->left_type === \App\Enum\ProthesisType::PROTHESIS_WRIST)
    <li class="order-block-item js-block-item-products">
        <div class="order-title js-slide-box">
            Протез левой кисти <i class="fa fa-arrow-right arrow" aria-hidden="true"></i>
        </div>

        <div class="user-data-profile js-box-close hide">
            <div class="order-body fieldset" data-level="wrist" data-side="left" data-server="left_wrist">
                <fieldset class="item-box">
                    ...
                    <div class="order-bottom">
                        <article class="order-bottom-link js-open-select green-color"
                                 data-knot="left-hand-wrist">Выбрать комплектующие
                        </article>
                    </div>
                </fieldset>
            </div>

            <div class="order-body fieldset" data-level="finger" data-side="left" data-server="left_wrist">
                <fieldset class="item-box">
                    <legend>{{\App\Enum\ProthesisLevel::FINGER->caption()}}х</legend>
                    <div class="order-empty">
                        Вы не выбрали комплектующие, Если вам не нужен этот узел просто пропустите его.
                    </div>
                    <ul class="item-box-list hide">
                    ...
                    <div class="order-bottom">
                        <article class="order-bottom-link js-open-select green-color "
                                 data-knot="left-hand-finger">Выбрать комплектующие
                        </article>
                    </div>
                </fieldset>
            </div>
