...
<section class="admin">
    <div class="wrap-user-data-profile user-data two-column">
        <div class="admin-title admin-title-page">
            Личные данные @if($user->role === App\Enum\UserRoles::MASTER->value)
                владельца
            @else
                пользователя
            @endif
        ...
        <div class="button-box">
            <div class="user-data-edit red-color password-switch">Изменить пароль</div>
            @if($user->role === \App\Enum\UserRoles::MASTER->value)
                <a class="user-data-edit green-color" href="{{route('admin.show.update', [$user->role, $user->id])}}">
